...
inline CwxAppConnInfo& CwxAppHandler4Channel::getConnInfo()
{
    return m_conn;
}

inline CwxAppConnInfo const& CwxAppHandler4Channel::getConnInfo() const
{
    return m_conn;
}
...
inline int CwxAppHandler4Channel::cancelWakeup()
{
...
inline int CwxAppHandler4Channel::wakeUp()
{
...
inline bool CwxAppHandler4Channel::isStopListen() const
{
    return m_bStopListen;
}

///设置stop listen
inline void CwxAppHandler4Channel::setStopListen(bool bStop)
{
    m_bStopListen = bStop;
}
...
///获取连接时的错误代码
inline int CwxAppHandler4Channel::getConnErrNo() const
{
    return m_connErrNo;
}
