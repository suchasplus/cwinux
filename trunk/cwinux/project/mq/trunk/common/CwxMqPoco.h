...
public:
    ...
    static int packRecvData(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
    ...
    ///返回值，CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseRecvData(CwxMqTss* pTss,
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packRecvDataReply(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        int ret,
        CWX_UINT64 ullSid,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseRecvDataReply(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        int& ret,
        CWX_UINT64& ullSid,
        char const*& szErrMsg,
    ...
    ///返回值，CWX_MQ_SUCCESS：成功；其他都是失败
    static int packCommit(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        char const* user=NULL,
        char const* passwd=NULL,
    ...
    ///返回值，CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseCommit(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        char const*& user,
        char const*& passwd,
        char* szErr2K=NULL);
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packCommitReply(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        int ret,
        char const* szErrMsg,
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseCommitReply(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        int& ret,
        char const*& szErrMsg,
        char* szErr2K=NULL);
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packReportData(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        CWX_UINT64 ullSid,
        bool      bNewly,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseReportData(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        CWX_UINT64& ullSid,
        bool&       bNewly,
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packReportDataReply(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        int ret,
        CWX_UINT64 ullSid,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseReportDataReply(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        int& ret,
        CWX_UINT64& ullSid,
        char const*& szErrMsg,
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packSyncData(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        CWX_UINT64 ullSid,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseSyncData(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        CWX_UINT64& ullSid,
        CWX_UINT32& uiTimeStamp,
        CwxKeyValueItem const*& data,
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packSyncDataReply(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        CWX_UINT32 uiTaskId,
        CWX_UINT64 ullSid,
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseSyncDataReply(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        CWX_UINT64& ullSid,
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packFetchMq(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        bool bBlock,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseFetchMq(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        bool& bBlock,
        char const*& queue_name,
        char const*& user,
    ...
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int packFetchMqReply(CwxMqTss* pTss,
        CwxMsgBlock*& msg,
        int  ret,
        char const* szErrMsg,
        CWX_UINT64 ullSid,
        ...
        char* szErr2K=NULL);
    ///返回值：CWX_MQ_SUCCESS：成功；其他都是失败
    static int parseFetchMqReply(CwxMqTss* pTss,
        CwxMsgBlock const* msg,
        int&  ret,
        char const*& szErrMsg,
        CWX_UINT64& ullSid,
